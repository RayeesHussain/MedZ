...
public class ReminderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSubmitbtn = (Button) findViewById(R.id.del1);
    ...
    private void setAlarm(String text, String date, String time) {
        ...
        Intent intentBack = new Intent(getApplicationContext(), ScheduleScreen.class);                //this intent will be called once the setting alaram is completes
