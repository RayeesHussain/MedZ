...
public class dbManager extends SQLiteOpenHelper {
    ...
    private static String dbname = "reminder";//reminder
    static final String TABLENAME1="tbl_reminder";//Table  name to store reminders in sqllite
   ...
   /* void deleteData(String row_id) {
        ...
        long result=db.delete(TABLENAME1,"id=?",new String[] {row_id});
        if (result == -1) {
